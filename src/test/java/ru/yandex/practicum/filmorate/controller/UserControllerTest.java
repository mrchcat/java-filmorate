...
class UserControllerTest {
    ...
    void TestUserControllerUpdateUser() {
        ...
        userController.addUserHandler(user);
        ResponseEntity<User> response = userController.updateUserHandler(user2);
        User answer = response.getBody();
        ...
        assertEquals(1, requireNonNull(userController.getAllUsersHandler().getBody()).size());
    }
    ...
    void TestUserControllerGetAllUsers() {
        ...
        userController.addUserHandler(user1);
        userController.addUserHandler(user2);
        userController.addUserHandler(user3);
        ResponseEntity<Collection<User>> response = userController.getAllUsersHandler();
    ...
    void TestUserControllerUpdateUserBadId() {
        ...
        assertEquals(user2.getName(), answer.getName());
        assertEquals(1, requireNonNull(userController.getAllUsersHandler().getBody()).size());
        assertTrue(userController.getAllUsersHandler().getBody().stream()
